...
Public Class Form34
    Private Sub TrackBar1_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TrackBar1.Scroll
        ...
        Try
            ...
            Dim r1 As Single = TrackBar1.Value / 100
            Dim r2 As Single = TrackBar2.Value / 100
            Dim g1 As Single = TrackBar3.Value / 100
            Dim g2 As Single = TrackBar4.Value / 100
            Dim b1 As Single = TrackBar5.Value / 100
            Dim b2 As Single = TrackBar6.Value / 100
            Dim r33, g33, b33, rgb33 As Single
            If RadioButton1.Checked = True Then
                For k As Integer = 0 To rgbValues.Length - Bpx Step Bpx
                    rgb33 += rgbValues(k)
                    rgb33 += rgbValues(k + 1)
                    rgb33 += rgbValues(k + 2)
                    If rgb33 = 0 Then rgb33 = 1
                    r33 = rgbValues(k + 2) / rgb33
                    g33 = rgbValues(k + 1) / rgb33
                    b33 = rgbValues(k) / rgb33
                    If r33 >= r1 And r33 <= r2 And g33 >= g1 And g33 <= g2 And b33 >= b1 And b33 <= b2 Then
                    Else
                        rgbValues(k + 3) = 1
                    End If
                    rgb33 = 0
    ...
    Private Sub TrackBar2_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TrackBar2.Scroll
        If TrackBar2.Value < TrackBar1.Value Then TrackBar1.Value = TrackBar2.Value
        Label1.Text = "R：" & TrackBar1.Value & "%~" & TrackBar2.Value & "%"
        Dim start_time As Date = Now
        Dim Width As Integer, Height As Integer
        Dim mBitmap As Bitmap
