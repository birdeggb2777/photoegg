Public Class Form1
        ...
        For height1 = 1 To t
            For width1 = 1 To r
                ...
                If rr + gg + bb >= 675 Then
                    png.SetPixel(a, b, Color.FromArgb(246, 230, 200))
    ...
    Private Sub 色ToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 色ToolStripMenuItem1.Click
        On Error Resume Next
        PictureBox2.Image = PictureBox1.Image
        Dim png As New Bitmap(PictureBox1.Image)
        PictureBox1.Image = png
    ...
    Private Sub 雜訊變色ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 雜訊變色ToolStripMenuItem.Click
        ...
        For c3 = 1 To r * t
            ...
            gg = co.G
            bb = co.B
            png.SetPixel(c1, c2, Color.FromArgb(gg, bb, rr))
        Next
    End Sub
    ...
    Private Sub 測試ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 測試ToolStripMenuItem.Click
        ...
        Dim i As Integer
        Dim co2, co3, co4, co5 As Color
        Dim rr2, gg2, bb2, rr3, gg3, bb3, rr4, gg4, bb4, rr5, gg5, bb5 As Integer
        Dim height2, width2 As Integer
        ...
        For height1 = 1 To t
            For width1 = 1 To r
                ...
                gg2 = co2.G
                bb2 = co2.B
                If rr + gg + bb = 675 Or rr + gg + bb = 600 Or rr + gg + bb = 525 Or rr + gg + bb = 450 Or rr + gg + bb = 375 Or rr + gg + bb = 300 Or rr + gg + bb = 225 Or rr + gg + bb = 150 Or rr + gg + bb = 75 Or rr + gg + bb = 0 Then
                    png.SetPixel(a, b, Color.FromArgb(rr2, gg2, bb2))
                    For i = 1 To 1
                        For height2 = 1 To t - 2
                            For width2 = 1 To r - 2
                                co3 = png.GetPixel(a1, b1)
                                rr3 = co3.R
                                gg3 = co3.G
                                bb3 = co3.B
                                co4 = png.GetPixel(a1, b1 + 1)
                                rr4 = co4.R
                                gg4 = co4.G
                                bb4 = co4.B
                                If co3 = co And co4 = co2 Then
                                    png.SetPixel(a1, b1, Color.FromArgb(rr2, gg2, bb2))
                                Else
                                    d1 = 1
                                End If
    ...
    Private Sub 交錯ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 交錯ToolStripMenuItem.Click
        On Error Resume Next
        PictureBox2.Image = PictureBox1.Image
        Dim png As New Bitmap(PictureBox1.Image)
        PictureBox1.Image = png
    ...
    Private Sub 測試3ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 測試3ToolStripMenuItem.Click
        PictureBox2.Image = PictureBox1.Image
        PictureBox5.Image = PictureBox1.Image
        Dim png As New Bitmap(PictureBox1.Image)
        Dim png2 As New Bitmap(PictureBox5.Image)
        ...
        For height1 = 1 To 30000
            ...
            gg = co.G
            bb = co.B
            co2 = png2.GetPixel(c1, c2)
            rr2 = co2.R
            gg2 = co2.G
            bb2 = co2.B
            If rr + gg + bb = 75 Or rr + gg + bb = 150 Or rr + gg + bb = 225 Or rr + gg + bb = 300 Or rr + gg + bb = 375 Or rr + gg + bb = 450 Or rr + gg + bb = 525 Or rr + gg + bb = 600 Or rr + gg + bb = 675 Then
                Dim hBrush As Integer = CreateSolidBrush(RGB(rr2, gg2, bb2))
                Dim g As Graphics
                g = Graphics.FromImage(png)
                Dim hdc As IntPtr = GetDC(PictureBox1.Handle)
                SelectObject(hdc, hBrush)
                Dim color As Integer
                color = GetPixel(hdc, c1, c2)
                ExtFloodFill(hdc, c1, c2, color, 1)
            End If
        Next
        '  a += 1
        ' Next
    ...
    End Sub
    Private Sub 測試5ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 測試5ToolStripMenuItem.Click
        On Error Resume Next
        PictureBox2.Image = PictureBox1.Image
        復原ToolStripMenuItem.Visible = True
        Dim png As New Bitmap(PictureBox1.Image)
        ...
        For height1 = 1 To t - 1
            For width1 = 1 To r - 1
                ...
                gg2 = co2.G
                bb2 = co2.B
                If (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 100 Then
                    png.SetPixel(a, b, Color.FromArgb(150, 150, 150))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 200 Then
                    png.SetPixel(a, b, Color.FromArgb(150, 150, 150))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 400 Then
                    png.SetPixel(a, b, Color.FromArgb(150, 150, 150))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 800 Then
                    png.SetPixel(a, b, Color.FromArgb(150, 150, 150))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 900 Then
                    png.SetPixel(a, b, Color.FromArgb(150, 150, 150))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 1000 Then
                    png.SetPixel(a, b, Color.FromArgb(125, 125, 125))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 6400 Then
                    png.SetPixel(a, b, Color.FromArgb(100, 100, 100))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 12800 Then
                    png.SetPixel(a, b, Color.FromArgb(75, 75, 75))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 25600 Then
                    png.SetPixel(a, b, Color.FromArgb(50, 50, 50))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 51200 Then
                    png.SetPixel(a, b, Color.FromArgb(25, 25, 25))
                ElseIf (rr - rr2) ^ 2 + (gg - gg2) ^ 2 + (bb - bb2) ^ 2 <= 102400 Then
                    png.SetPixel(a, b, Color.FromArgb(0, 0, 0))
                Else
                    png.SetPixel(a, b, Color.FromArgb(150, 150, 150))
                End If
