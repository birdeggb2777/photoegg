...
Public Class Form1
    ...
    Public Property StretchImage As PictureBoxSizeMode
    ...
    Private Sub EnglishToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EnglishToolStripMenuItem.Click
        ...
        迷宮ToolStripMenuItem.Text = "Box maze"
    ...
    Private Sub 日本語ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 日本語ToolStripMenuItem.Click
        ...
        迷宮ToolStripMenuItem.Text = "ブロック迷路"
    ...
    Private Sub 色域選擇ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 色域選擇ToolStripMenuItem.Click
        ...
        If ya = 6 Then
            ...
            方框模糊ToolStripMenuItem.Enabled = False
            朦朧ToolStripMenuItem.Enabled = False
            玻璃ToolStripMenuItem.Enabled = False
            Dim w As New Form28
            w.ShowDialog()
        End If
    End Sub
        ...
        For z = 1 To 5
            Try
                ...
                For k As Integer = widt * 4 * 10 + 4 To rgbValues.Length - Bpx - widt * 4 * 10 - 4 Step Bpx
                    bb = CByte(rgbValues(k - 4 * 10))
                    gg = CByte(rgbValues(k + 1 - 4 * 10))
                    rr = CByte(rgbValues(k + 2 - 4 * 10))
                    bb2 = CByte(rgbValues(k + widt * 4 * 10))
                    gg2 = CByte(rgbValues(k + 1 + widt * 4 * 10))
                    rr2 = CByte(rgbValues(k + 2 + widt * 4 * 10))
                    bb3 = CByte(rgbValues(k - widt * 4 * 10))
                    gg3 = CByte(rgbValues(k + 1 - widt * 4 * 10))
                    rr3 = CByte(rgbValues(k + 2 - widt * 4 * 10))
                    bb4 = CByte(rgbValues(k + 40))
                    gg4 = CByte(rgbValues(k + 1 + 40))
                    rr4 = CByte(rgbValues(k + 2 + 40))
                    rgbValues(k) = (bb + bb2 + bb3 + bb4) / 4
                    rgbValues(k + 1) = (gg + gg2 + gg3 + gg4) / 4
                    rgbValues(k + 2) = (rr + rr2 + rr3 + rr4) / 4
                    If Bpx = 4 Then
    ...
    Private Sub 色彩修正ToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles 色彩修正ToolStripMenuItem1.Click
        ...
        System.GC.Collect()
        rgb = (rr + gg + bb) / 3
        Dim tra As Single = 127 / rr
        Dim tra2 As Single = 127 / gg
        Dim tra3 As Single = 127 / bb
        Try
            mBitmap = New Bitmap(PictureBox1.Image)
            Width = mBitmap.Width
            Height = mBitmap.Height
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim wid As Integer = CInt(PictureBox2.Width / 3)
        Dim hgt As Integer = CInt(PictureBox2.Height / 3)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            Dim rgbA As Byte
            Dim widt As Integer = PictureBox1.Width
            Dim tra As Integer = 7 'TrackBar1.Value
            For k As Integer = 0 To rgbValues.Length - Bpx - widt * tra * 4 - 4 * tra Step Bpx
                B = CByte(255 - rgbValues(k + widt * tra * 4 + 4 * tra))
                G = CByte(255 - rgbValues(k + 1 + widt * tra * 4 + 4 * tra))
                R = CByte(255 - rgbValues(k + 2 + widt * tra * 4 + 4 * tra))
        ...
        Try
            ...
            Dim rgbA As Byte
            Dim rr, gg, bb As Byte
            Dim tra2 As Integer = 126 ' TrackBar2.Value
            For k As Integer = 0 To rgbValues.Length - Bpx Step Bpx
                bb = CByte(rgbValues(k))
                gg = CByte(rgbValues(k + 1))
                rr = CByte(rgbValues(k + 2))
        ...
        PictureBox3.Image = re03
        System.GC.Collect()
    End Sub
    Private Sub 水墨畫ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 水墨畫ToolStripMenuItem.Click
        re03 = PictureBox3.Image
        PictureBox1.Width = rrrr
        PictureBox1.Height = tttt
        re2(re02) = PictureBox1.Image
        re02 += 1
